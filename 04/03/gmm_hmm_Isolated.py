...
def train():
    ...
    np.save("model/models_hmmlearn.npy", models)


def test():
    test_dir = "data\\test\\"
    models = np.load("model\\models_hmmlearn.npy", allow_pickle=True)
    count = 0
    count2 = 0
    for i in range(98):
        # 读取 wav 文件
